...
const SoftwareCard: React.FC<SoftwareCardProps> = ({ imageSrc, title, description }) => {
    return (
        <div className="w-60 h-88 mx-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow shadow-gray-400 dark:shadow-none dark:border border-gray-700 cursor-pointer hover:-translate-y-1 transition-all duration-300">
